...
QMAKE    = /usr/bin/qmake
qt.xcodeproj/project.pbxproj: qt.pro  /usr/local/Qt4.6/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.6/mkspecs/common/unix.conf \
	...
	$(QMAKE) -macx -o qt.xcodeproj/project.pbxproj qt.pro
